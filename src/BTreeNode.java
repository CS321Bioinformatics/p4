...
public class BTreeNode {
	...
	public int parent, leftChild, rightChild, node, nodeSize;
	public int numKeys;
...
//		int numObjects = 1;
		nodeLocation = 0;
		parent = -1; // the root cant be it's own parent
		keyList = new ArrayList<TreeObject>();
//		children = new ArrayList<Long>();
		children1 = new ArrayList<Integer>();
	}
	//if not root
	//TODO Don't need because the new node has to always be the root node since we add new nodes to the top of the tree
